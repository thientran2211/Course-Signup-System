...
namespace Course_Signup_System.Controllers
{
    ...
    public class SubjectGroupController : ControllerBase
    {
        ...
        {
            var subjectGroups = await subjectGroupService.GetSubjectGroupsAsync();
        ...
        {
            var subjectGroup = await subjectGroupService.GetSubjectGroupByIdAsync(id);
        ...
        {
            var subjectGroup = await subjectGroupService.AddNewSubjectGroupAsync(subjectGroupDto);
            return Ok(subjectGroup);
        }
        ...
        {
            var subjectGroup = await subjectGroupService.UpdateSubjectGroupAsync(id, subjectGroupDto);
            return Ok(subjectGroup);
        }
        ...
        {
            await subjectGroupService.DeleteSubjectGroupAsync(id);
